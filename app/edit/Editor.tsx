...
type Template = { id: string; kind: Exclude<VisualBlockKind, "native">; label: string; icon: string; title?: string; body?: string; buttonLabel?: string; href?: string; imageUrl?: string; style?: BlockStyle };
