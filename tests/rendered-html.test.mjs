...
test("public home page renders the newsletter default content", async () => {
  ...
  assert.match(html, /TAMU First Day of Classes — Fall 2026/);
  assert.match(html, /New LTOs/);
  assert.match(html, /TAMU Soccer vs\. Air Force/);
  assert.match(html, /Legends Invitational/);
  assert.match(html, /Aggie Mom Fall Federation Weekend/);
  assert.match(html, /TAMU Volleyball Invitational/);
